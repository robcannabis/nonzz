...
client.on('ready', async () => {
 ...
 const num = parseFloat((Math.random() * 0.2 + 0.1 + Number.EPSILON).toFixed(1));
  ...
  setInterval(() => {
    ...
    const ddds = ['https://discord.gg/p7skBH5fKF']; // ลิ้ง button1

   const iooi = ['Instagram']; // ชื่อ button 2
   const iiio = ['https://www.instagram.com/_non_nonthakorn?igsh=MWc1bzV5dXhjdjAzYQ==']; // ลิ้ง button 2
